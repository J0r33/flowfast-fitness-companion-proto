...
export default function WorkoutPlayer() {
  ...
  // Countdown timer
  useEffect(() => {
    if (!session || remainingSeconds === null || remainingSeconds <= 0 || isPaused || timerComplete || !timerStarted)
      return;
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription className="pt-4">{currentStep.tooltipInstructions}</DialogDescription>
                </DialogHeader>
              </DialogContent>
            </Dialog>
          </div>
