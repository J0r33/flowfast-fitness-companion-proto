    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <main className="max-w-md mx-auto px-6 py-6">
        <div className="space-y-6">
          {step === "energy" && <EnergySelector selected={energy} onSelect={setEnergy} />}

          {step === "time" && <TimeSelector selected={time} onSelect={setTime} />}

          {step === "focus" && <FocusAreaSelector selected={focusAreas} onToggle={toggleFocusArea} />}
